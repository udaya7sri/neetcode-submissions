class Library:
    ...
    @classmethod
    def lend_books(cls,number_of_books_lent:int)->None:
        cls.books_available -= number_of_books_lent
    # TODO: Implement return_books method to increase the number of books available
    @classmethod
    def return_books(cls,number_of_books_returned:int)->None:
        cls.books_available+=number_of_books_returned
